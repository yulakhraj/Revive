...
const IMG = (id: string) => `https://images.unsplash.com/${id}?w=600&h=800&fit=crop&auto=format&q=72`;

// Curated, e-commerce-style Unsplash photos grouped by what they actually show.
// All IDs verified against the existing data set so they load reliably.
const POOLS = {
  jeansMen: ['photo-1542272604-787c3835535d', 'photo-1602293589930-45aad59ba3ab', 'photo-1714143136372-ddaf8b606da7', 'photo-1582552938357-32b906df40cb'],
  jeansWomen: ['photo-1541099649105-f69ad21f3246', 'photo-1602293589930-45aad59ba3ab', 'photo-1637069585336-827b298fe84a', 'photo-1542272604-787c3835535d'],
  hoodies: ['photo-1556821840-3a63f95609a7', 'photo-1509967419530-da38b4704bc6', 'photo-1554568218-0f1715e72254'],
  tshirts: ['photo-1521572163474-6864f9cf17ab', 'photo-1576566588028-4147f3842f27', 'photo-1583743814966-8936f5b7be1a'],
  shirts: ['photo-1596755094514-f87e34085b2c', 'photo-1598033129183-c4f50c736f10', 'photo-1512436991641-6745cdb1723f'],
  jacketsMen: ['photo-1551537482-f2075a1d41f2', 'photo-1521223890158-f9f7c3d5d504', 'photo-1591047139829-d91aecb6caea', 'photo-1551028719-00167b16eac5'],
  jacketsWomen: ['photo-1591047139829-d91aecb6caea', 'photo-1539571696357-5a69c17a67c6', 'photo-1551537482-f2075a1d41f2'],
  suits: ['photo-1507679799987-c73779587ccf', 'photo-1507003211169-0a1dd7228f2d'],
  trousers: ['photo-1594633312681-425c7b97ccd1'],
  cargo: ['photo-1624378439575-d8705ad7ae80'],
  shorts: ['photo-1591195853828-11db59a44f6b'],
  activewear: ['photo-1517838277536-f5f99be501cd', 'photo-1506152983158-b4a74a01c721'],
  dresses: ['photo-1572804013309-59a88b7e92f1', 'photo-1496747611176-843222e1e57c', 'photo-1595777457583-95e059d581b8'],
  skirts: ['photo-1582142407894-ec85a1268a4e'],
  tops: ['photo-1564257631407-4deb1f99d992', 'photo-1614975058789-41316d0e2e9c'],
  jumpsuits: ['photo-1496747611176-843222e1e57c', 'photo-1582533561751-ef6f6ab93a2e'],
  coords: ['photo-1515886657613-9f3515b0c78f', 'photo-1572804013309-59a88b7e92f1'],
  sarees: ['photo-1610030469983-98e550d6193c'],
  ethnicMen: ['photo-1594938298603-c8148c4dae35'],
  ethnicWomen: ['photo-1610030469983-98e550d6193c', 'photo-1617627143750-d86bc21e42bb', 'photo-1631857455684-a54a2f03665f', 'photo-1581044777550-4cfa60707c03'],
  innerwearMen: ['photo-1601393710008-984348f7447b', 'photo-1617951907145-53f6eb87a3a3', 'photo-1656587132121-aaccc57589cf', 'photo-1601393709771-3938c63d41a6'],
  innerwearWomen: ['photo-1597092451116-27787c07901d', 'photo-1568663521381-33b7c467fda0', 'photo-1546464750-77d1763f6401', 'photo-1660070605791-e5146f71ceb2', 'photo-1621416894569-0f39ed31d247', 'photo-1574539602047-548bf9557352', 'photo-1603796846097-bee99e4a601f'],
  sneakers: ['photo-1549298916-b41d501d3772'],
  accessories: ['photo-1572635196237-14b3f281503f', 'photo-1608256246200-53e635b5b65f'],
  loungewear: ['photo-1515434126000-961d90ff09db'],
  vintage: ['photo-1534126416832-a88fdf2911c2', 'photo-1614975058789-41316d0e2e9c', 'photo-1558618666-fcd25c85f82e'],
  genx: ['photo-1598033129183-c4f50c736f10', 'photo-1512436991641-6745cdb1723f', 'photo-1576566588028-4147f3842f27', 'photo-1534126416832-a88fdf2911c2'],
  premium: ['photo-1591047139829-d91aecb6caea', 'photo-1558171813-4c088753af8f', 'photo-1521223890158-f9f7c3d5d504'],
  streetwear: ['photo-1588117305388-c2631a279f82', 'photo-1554568218-0f1715e72254'],
  outerwear: ['photo-1551488831-00ddcb6c6bd3', 'photo-1591047139829-d91aecb6caea'],
};

// Map categoryId → pool. Falls back if name keywords don't match first.
const CATEGORY_POOLS: Record<string, string[]> = {
  'men-tshirts': POOLS.tshirts,
  'men-oversized': POOLS.tshirts,
  'men-shirts': POOLS.shirts,
  'men-hoodies': POOLS.hoodies,
  'men-jackets': POOLS.jacketsMen,
  'men-jeans': POOLS.jeansMen,
  'men-cargo': POOLS.cargo,
  'men-shorts': POOLS.shorts,
  'men-activewear': POOLS.activewear,
  'men-suits': POOLS.suits,
  'men-ethnic': POOLS.ethnicMen,
  'men-innerwear': POOLS.innerwearMen,
  'women-tops': POOLS.tops,
  'women-dresses': POOLS.dresses,
  'women-hoodies': POOLS.hoodies,
  'women-jeans': POOLS.jeansWomen,
  'women-skirts': POOLS.skirts,
  'women-trousers': POOLS.trousers,
  'women-jumpsuits': POOLS.jumpsuits,
  'women-activewear': POOLS.activewear,
  'women-ethnic': POOLS.ethnicWomen,
  'women-sarees': POOLS.sarees,
  'women-innerwear': POOLS.innerwearWomen,
  'women-coords': POOLS.coords,
  'women-jackets': POOLS.jacketsWomen,
  'unisex-streetwear': POOLS.streetwear,
  'unisex-vintage': POOLS.vintage,
  'unisex-y2k': POOLS.coords,
  'unisex-sneakers': POOLS.sneakers,
  'unisex-outerwear': POOLS.outerwear,
  'unisex-loungewear': POOLS.loungewear,
  'unisex-genx': POOLS.genx,
  'unisex-accessories': POOLS.accessories,
  'premium': POOLS.premium,
};

// Name-keyword overrides — checked first so a "Saree" in `women-ethnic` still shows a saree.
const NAME_KEYWORD_RULES: Array<{ match: RegExp; pool: string[] }> = [
  { match: /saree/i, pool: POOLS.sarees },
  { match: /kurta|kurti|anarkali|chikankari/i, pool: POOLS.ethnicWomen },
  { match: /sneaker|trainer/i, pool: POOLS.sneakers },
  { match: /sunglass|shade/i, pool: ['photo-1572635196237-14b3f281503f'] },
  { match: /bralette|panties|thong|bodysuit|brief.*women|hipster brief|panty/i, pool: POOLS.innerwearWomen },
  { match: /boxer|briefs|trunks/i, pool: POOLS.innerwearMen },
  { match: /bra(?!nd)/i, pool: POOLS.innerwearWomen },
  { match: /denim jacket|jean jacket|leather jacket|biker|bomber|trench|shacket/i, pool: POOLS.jacketsMen },
  { match: /blazer|tweed/i, pool: POOLS.suits },
  { match: /hoodie|sweatshirt/i, pool: POOLS.hoodies },
  { match: /flannel|corduroy.*shirt|button.?up.*shirt|denim shirt/i, pool: POOLS.shirts },
  { match: /cardigan|knit vest|knit sweater|sweater|knitwear/i, pool: POOLS.vintage },
  { match: /skirt/i, pool: POOLS.skirts },
  { match: /dress(?!ed)|kimono|wrap dress|slip dress/i, pool: POOLS.dresses },
  { match: /co.?ord|crop.*set/i, pool: POOLS.coords },
  { match: /dungaree|jumpsuit/i, pool: POOLS.jumpsuits },
  { match: /cargo pant|cargo short/i, pool: POOLS.cargo },
  { match: /cargo jean/i, pool: POOLS.jeansWomen },
  { match: /short(?!s.*set)/i, pool: POOLS.shorts },
  { match: /jeans|denim pant/i, pool: POOLS.jeansMen },
  { match: /trousers|linen pant/i, pool: POOLS.trousers },
  { match: /track pant|jogger|legging|gym/i, pool: POOLS.activewear },
  { match: /tee|t.?shirt|graphic.*tee/i, pool: POOLS.tshirts },
  { match: /loungewear|robe/i, pool: POOLS.loungewear },
  { match: /sweater vest/i, pool: POOLS.tops },
];
...
function resolveImages(product: Product): string[] {
  for (const rule of NAME_KEYWORD_RULES) {
    if (rule.match.test(product.name)) {
      const start = hashId(product.id) % rule.pool.length;
      return rule.pool.length >= 2
        ? [rule.pool[start], rule.pool[(start + 1) % rule.pool.length]]
        : [rule.pool[start]];
    }
  }
  const pool = CATEGORY_POOLS[product.categoryId] || POOLS.streetwear;
  const start = hashId(product.id) % pool.length;
...
export const mockProducts: Product[] = baseMockProducts.map((product) => {
  const photoIds = resolveImages(product);
  return {
    ...product,
    images: photoIds.map((photoId, index) => ({
      id: `i${product.id}-${index}`,
